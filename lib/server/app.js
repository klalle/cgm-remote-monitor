...
function create (env, ctx) {
  ...
  var ks = require('../kitescout/server')(env, ctx);
  app.use('/kitescout',ks);// require('../../KiteScout/server/index.js')(env, ctx)) //add kitescout express app...

  // var os = require('../omnipod_stash/server')(env, ctx);
  // app.use('/omnipodstash',os);// require('../../KiteScout/server/index.js')(env, ctx)) //add kitescout express app...
